...
namespace Convai.Scripts.Runtime.Core
{
    ...
    public class ConvaiGRPCAPI : MonoBehaviour
    {
            ...
            string characterID, ActionConfig actionConfig, FaceModel faceModel, string speakerID)
        {
            ...
            ConvaiLogger.Info((_activeConvaiNPC?.characterName ?? "Character") + " is now listening", ConvaiLogger.LogCategory.Character);
        ...
        public void StopRecordAudio()
        {
            ...
            try
            {
                ConvaiLogger.Info((_activeConvaiNPC?.characterName ?? "Character") + " has stopped listening", ConvaiLogger.LogCategory.Character);
